...
export function Select({ items, icon, value, ...props }: Omit<JSX.SelectHTMLAttributes<HTMLSelectElement>, 'value'> & {
  ...
  return <select {...props} class="codex-select" value={String(value)}>
